...
model = torch.hub.load(repo_or_dir='idarshan07/website-objects-detection-with-YOLOv5/', model='/website-objects-detection-with-YOLOv5/yolov5-master', path="model/best.pt", source="local")
